...
AppUdpCtrlPrtLst = 5556
AppUdpNavDtaPrtLst = 5554
AppUdpRwCapLst = 5557
...
#	UdpLsn(AppLstnHost, AppUdpXPrtLst, FlRlyTgtHost, FlRlyUdpXPrtTrgt)
	...
	data='// Simulate some Navdata values
        navdata_unpacked.ardrone_state = 0;
        navdata_unpacked.vx = 10;  
        navdata_unpacked.vy = 5;   
        navdata_unpacked.vz = 0;   
        navdata_unpacked.altitude = 1500;  
        navdata_unpacked.rotX = 0.1;
        navdata_unpacked.rotY = 0.2;
        navdata_unpacked.rotZ = 45.0;'
...
while data:
        ...
        print 'd,a=',data, addr
        UdpCSktLst.sendto(data, UdpCSktLst)
        print'DTA, to:',data, UdpCSktLst
